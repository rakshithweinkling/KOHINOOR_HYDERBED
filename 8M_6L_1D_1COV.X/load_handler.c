...
void setLightState(uint8_t touchID, bool state) {
    switch (touchID) {
        ...
        case T5: if (state) L3_SetHigh(); else L3_SetLow(); break;
        case T6: if (state) L4_SetHigh(); else L4_SetLow(); break;
        case T7: if (state) L5_SetHigh(); else L5_SetLow(); break;
        case T8: if (state) L7_SetHigh(); else L7_SetLow(); break;
        //case T: if (state) L6_SetHigh(); else L6_SetLow(); break;        
        default: break;
    }
}
...
void uartLight(char received) {
    switch (received) {
        case 'a': L6_SetHigh(); break;
        case 'b': L6_SetLow(); break;
        case 'c': L1_SetHigh(); break;
        case 'd': L1_SetLow(); break;
        case 'e': L2_SetHigh(); break;
        case 'f': L2_SetLow(); break;
        case 'g': L3_SetHigh(); break;
        case 'h': L3_SetLow(); break;
        case 'i': L4_SetHigh(); break;
        case 'j': L4_SetLow(); break;
        case 'k': L5_SetHigh(); break;
        case 'l': L5_SetLow(); break;
