...
TouchIRControl controls[NUM_GENERAL_TOUCH] = {
    { T1, 'I', 'J', false, false, 1, 2 },
    { T2, 'a', 'b', false, false, 1, 5 },
    { T4, 'c', 'd', false, false, 1, 0 },
    { T5, 'e', 'f', false, false, 0, 5 },
    { T6, 'K', 'L', false, false, 1, 8 }
};

// ----------------------------- Fan Base Configuration -----------------------------
FanControl fans[2] = {
   // { &fan1_state, &fan1, &ld1, &fn1, 'q', 'r', '0', 1, 5, 1, 7, 1, 3 },
    //{ &fan2_state, &fan2, &ld2, &fn2, 's', 't', '5', 1, 0, 1, 7, 1, 3 }
};
...
//    { F25, '5', &fan2, &ld2, false },
//    { F24, '6', &fan2, &ld2, false },
//    { F23, '7', &fan2, &ld2, false },
//    { F22, '8', &fan2, &ld2, false },
//    { F21, '9', &fan2, &ld2, false }
};
