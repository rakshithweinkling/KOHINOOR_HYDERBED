...
//                ld1 = 0; ld2 = 0;
        ...
        // Handle user input and control logic for light,plug,curtain
        handleGeneralTouchControls();
        // Handle user input and control logic for Dimmer,fan
       // handleFanToggleControls();
       // handleFanSpeedControl();
       // fanscon();
        // Handle user input and control logic for IR control
        ir_handler();
    }
}